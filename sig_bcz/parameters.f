!--------------------------------------------------------------------!
	subroutine parameters (afilepar)
!	The input data necessary to fit the signal is entered here
		...
		!--- Read from namelist input file (should go in a function) -
...
!		write(6,nml=sig_bcz_controls)
		...
		!-++
		! Reading the new values from the file:
		icalc=0
		ipara=0
		ioutp=0
		idata=0
